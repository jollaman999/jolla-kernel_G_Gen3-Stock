...
#if defined(CONFIG_S5K4E5YA) || defined (CONFIG_OV5693) /* LGE_CHANGE, bring-up ov5693 for dual sourcing, 2014-03-05, jungryoul.choi@lge.com */
...
static struct msm_bus_vectors cam_zsl_vectors[] = {
	{
		.src = MSM_BUS_MASTER_VFE,
		.dst = MSM_BUS_SLAVE_EBI_CH0,
		.ab  = 411635520, // 302071680  /* LGE_CHANGE, increase absolute bandwidth to avoid vfe overflow, 2013-06-21, john.park@lge.com */
		.ib  = 1812430080,
	},
	{
		.src = MSM_BUS_MASTER_VPE,
...
#if defined (CONFIG_S5K4E5YA_ACT) || defined (CONFIG_OV5693_ACT) /* LGE_CHANGE, bring-up ov5693 for dual sourcing, 2014-03-05, jungryoul.choi@lge.com */
