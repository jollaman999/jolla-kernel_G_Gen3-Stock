...
static struct pm8xxx_keypad_platform_data keypad_data = {
	.input_name             = "gvarfhd-keypad-8064",
	.input_phys_device      = "gvarfhd-keypad-8064/input0",
#if defined(CONFIG_MACH_APQ8064_GVAR_CMCC)
	.num_rows               = 2,
	.num_cols               = 5,
#else
...
static struct i2c_registry gvarcmcc_i2c_pm_subsystem __initdata = {
