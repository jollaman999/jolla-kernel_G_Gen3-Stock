...
/* LGE_CHANGE_S, Move to here from msm_camera.h on JB MR1 to avoid build error, 2013.4.19, jungki.kim[Start] */
...
/* LGE_CHANGE_E, Move to here from msm_camera.h on JB MR1 to avoid build error, 2013.4.19, jungki.kim[End] */
