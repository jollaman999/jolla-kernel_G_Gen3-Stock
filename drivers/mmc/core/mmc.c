...
/* LGE_CHANGE_START jinyoun.park 2013-11-13, Support for TOSHIBA THGBMBG7D2KBAIL*/
	if (card->ext_csd.rev > 7) {
/* LGE_CHANGE_END jinyoun.park 2013-11-13, Support for TOSHIBA THGBMBG7D2KBAIL*/
