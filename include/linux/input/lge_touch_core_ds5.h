...
#if !defined(CONFIG_MACH_MSM8974_VU3_KR) && !defined(CONFIG_LGE_Z_TOUCHSCREEN) && !defined(CONFIG_MACH_APQ8064_OMEGAR_KR) && !defined(CONFIG_MACH_APQ8064_OMEGA_KR)
#define A1_only
...
#define KNOCKON_MASK
#define RESOLUTION_FROM_FW
#define CUST_G2_TOUCH_WAKEUP_GESTURE
#define MINIMUM_PEAK_AMPLITUDE_REG    0x15	//OMEGA_TOUCH_THERMAL_CHECK
#define SMALL_FINGER_AMPLITUDE_THRESHOLD_REG    0x17	//ime drumming in TA or Thermal
#endif

#ifdef CUST_G2_TOUCH_WAKEUP_GESTURE
#define REPORT_WAKEUP_GESTURE_ONLY_REG	0x19 //offset 2,  bit:2
...
extern bool report_lpwg; /* Set '1' when first multi tap event is occured */
extern bool wait_reply; /* avoid duplicated uevent */
#endif
